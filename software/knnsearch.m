...
function d=histogram_intersection(a,b)
  ...
  % -------------- write your own code here ---------------
  sum_a = sum(a);%sum of 1 is assigned to sum_a
  d = 1 - (sum(min(a,b))/sum_a);%Inorder to find the intersection the sum of minimum between a and b divided by sum_a is deducted from 1. 
 end 
